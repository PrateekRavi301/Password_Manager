...
def mainPasswordKeeper(username):
    ...
    root.iconbitmap("ExtraSupportContent/logo.ico")
    width = 500
    height = 300
    ...
    def add():
        ...
        try:
            ...
            add_new.iconbitmap("ExtraSupportContent/logo.ico")
            width2 = 500
            height2 = 600
    ...
    def search():
        top = Toplevel()
        top.title("Search...")
        top.iconbitmap("ExtraSupportContent/logo.ico")
    ...
    def edit():
        ...
        def edit_record():
            ...
            if id_entry.get() == "":
                ...
                edit_new.iconbitmap("ExtraSupportContent/logo.ico")
                width3 = 500
                height3 = 600
    ...
    def delete():
        ...
        delete_record.iconbitmap("ExtraSupportContent/logo.ico")
        width2 = 350
        height2 = 300
        ...
        def delete_passwrd():
            try:
                if messagebox.askokcancel("Sure?", "Are you sure you want to delete this record?") == 1:
                    id_var = id_entry.get()
                    print(id_entry.get())
    ...
    def exit_program():
        ...
        bye = Tk()
        bye.title("BYE!")
        bye.iconbitmap("ExtraSupportContent/logo.ico")
        width = 500
        height = 530
        ...
        my_img = ImageTk.PhotoImage(Image.open("ExtraSupportContent/logo.png"))
